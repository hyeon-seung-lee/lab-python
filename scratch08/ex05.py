...
theta = mini_batch_gd(displ_cty, epochs=200, shuffle=False)
print(theta)
print('== batch gradient descent ==')
theta_batch = mini_batch_gd(displ_cty, epochs=1000, batch_size=len(displ_cty), learning_rate=0.01)
print(theta_batch)

# 미니 배치 경사 하강법
print('=== mini batch gradient descent ===')
theta_min = mini_batch_gd(displ_cty, epochs=1000, learning_rate=0.01, batch_size=32)
print(theta_min)