...
#   target: 레이블(분류 클래스)
# print(iris)
print('data shape:', bc_data.data.shape)
print('iris target:', bc_data.target_names)
print('iris features:', bc_data.feature_names)

X = bc_data.data  # 데이터(특성, 변수)
print('type X:', type(X))
print(X[:5])
y = bc_data.target  # 분류 클래스(레이블)
print('type y:', type(y))
print(y[:5])
